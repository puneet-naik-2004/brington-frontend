...
// //       {/* Row 1 */}
// //       <h6 className="row-head">Sample Numbers</h6>
// //       <h2 className="row-title">Row No. 1</h2>
// //       <Swiper
...
// //       {/* Row 2 */}
// //         <h6 className="row-head">Sample Numbers</h6>
// //       <h2 className="row-title">Row No. 2</h2>
// //       <Swiper
// //         modules={[Navigation, Pagination]}
// //         spaceBetween={20}
// //         navigation
...
export default function TwoRowsNumberSwiper() {
  ...
  useEffect(() => {
    const items = document.querySelectorAll(".number-box");
